...
export const hooks: Hook[] = [
  ...
  headroom:
    ...
    detail: [
      ...
      'The compression is real, confirmed at the upstream (the mock tallies the tokens it actually received): an 11&nbsp;KB noisy tool-log history goes <strong>2,832 → 1,422 input tokens (−50%)</strong>; a RAG dump −49.5%. Savings are content-dependent (noisy tool/log/RAG compresses 40–90%); short conversational chats abstain and pass through byte-identical (100% abstain over 100 short chats), and if the hook is ever slow, wrong, or down the request proceeds with its original body.',
