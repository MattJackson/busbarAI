...
- **38 µs** for a small call
- **84 µs** for a full 12k-token *cross-protocol* translation (Anthropic in, a different protocol out, both directions)

And the tail stays tight: p99.9 is only **~1.3–1.6× the median**, because a no-GC request path has no pauses to spike it. [Full methodology and per-protocol numbers →](/benchmark/)
