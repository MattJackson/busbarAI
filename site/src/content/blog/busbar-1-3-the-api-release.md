...
Everything above ships in the same single static Rust binary. The default path, with no hooks and
no chains configured, is byte-identical to 1.2; the zero-cost floor is a design rule, not an
