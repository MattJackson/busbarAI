...
description: "As teams go multi-model, the gateway becomes critical infrastructure — and 'flatten everything to OpenAI and retry on failure' isn't enough. Before I write a line of code, here's what I'm setting out to build."
date: 2026-05-07
...
- **Retry-on-failure** is error handling, not failover. The call throws, *then* something retries — after your user already felt the stall. And a naive retry can hammer a provider that's already down.
