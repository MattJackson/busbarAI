...
func main(){
 ...
 conc:=flag.Int("c",200,"");dur:=flag.Int("d",12,"");psize:=flag.Int("psize",0,"pad content to N bytes");flag.Parse()
 ...
 fmt.Printf("rps=%d fail=%d p50=%.2f p99=%.2f\n",int64(float64(ok)/float64(*dur)),fail,p(0.5),p(0.99))
}
