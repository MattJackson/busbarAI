// Renders the "Claude Code + Busbar" OG card (1200x630) to site/public/og/claude-code.png
...
await sharp(Buffer.from(svg)).png().toFile('../../site/public/og/claude-code.png');
console.log('OG card written to site/public/og/claude-code.png');
